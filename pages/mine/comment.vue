<template>
	<view class="wrap yjfk-form-right">
		...
		<u-form class="form" :model="model" :rules="rules" ref="uForm" label-position="top" style="margin: 20rpx;">
		...
		<view class="form-footer">
			<u-button class="btn" type="primary" @click="submit" style="margin: 20rpx;">提交</u-button>
